...
type GroupPartParam = Parameters<
  NonNullable<React.ComponentProps<typeof MessagePrimitive.GroupedParts>["groupBy"]>
>[0];

const opsGroupBy = (part: GroupPartParam) => {
  if (part.type === "tool-call") {
    if (GUARDED_TOOLS.has(part.toolName)) {
      return [];
    }
...
const AssistantMessage: FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <MessagePrimitive.GroupedParts groupBy={opsGroupBy}>
          {({ part, children }) => {
            switch (part.type) {
